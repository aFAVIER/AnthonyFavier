...
<body class="container-fluid">
	...
	<main id="wrap" class="row">
	 
		<!-- La navigation -->
		<ul id="nav" class="row text-center list-unstyled">
			<li class=" col-xs-4 col-sm-4 col-md-offset-3 col-md-2"><a href="#s1">Accueuil</a></li>
			<li class=" col-xs-4 col-sm-4 col-md-2"><a href="#s2">A propos de moi</a></li>
			<li class=" col-xs-4 col-sm-4 col-md-2"><a href="#s3">Contact</a></li>
		</ul>
	 
		<!-- Le slide 1 -->
		<section id="slide1">
			<div class="row">
				<article class="slide_inside col-offset-md-3 col-md-6 col-lg-offset-3 col-lg-6">
					<h1 class="text-center">Anthony FAVIER</h1>
					<h1 class="text-center">Developpeur Web</h1>
		...
		<section id="slide2">
			<div class="row">
				<article class="slide_inside col-md-offset-3 col-md-6 col-lg-offset-3 col-lg-6">
		...
		<section id="slide3">
			<div class="row">
				<article class="slide_inside row col-md-offset-3 col-md-6 col-lg-offset-3 col-lg-6">	
					<div class="col-md-5">		
						<h2>Contact</h2><br>		
					...
					<div class="col-md-offset-1 col-md-6 embed-responsive embed-responsive-4by3">
						<iframe id="map" class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d44203.73524511744!2d3.3741122511065167!3d46.17596144350246!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f12d0c3d9441d5%3A0x4093cafcbebbb70!2s03110+Saint-R%C3%A9my-en-Rollat!5e0!3m2!1sfr!2sfr!4v1488667404235"  frameborder="0" allowfullscreen></iframe>
					</div>
				</article>
			</div>	 
